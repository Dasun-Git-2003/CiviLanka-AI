// backend/shared/mockDataStore.js
// In-Memory state store supporting standalone development, testing, and team integration.
...
let workOrders = [
  ...
  },
  {
    ...
    description: "Severe depression and subgrade erosion posing rollover risk to heavy buses and commercial vehicles.",
  ...
  },
  {
    ...
    status: "ASSIGNED",
    ai_recommendation: "Low cost repair (< LKR 1,000, non-arterial). Auto-approved under routine maintenance policy.",
    approval_status: "APPROVED",
    approver_name: "System Auto-Approved",
    approval_date: "2026-09-18T09:00:00Z",
    materials_json: ["Thermal fuse 16A", "Weatherproof junction box", "Insulation tape"],
  ...
  },
  {
    ...
    materials_json: ["Cold mix bitumen 250kg", "Tack coat primer 20L", "Compactor fuel"],
    before_photo: "https://images.unsplash.com/photo-1515162816999-a0c47dc192f7?w=600&auto=format&fit=crop&q=80",
    after_photo: null,
    completion_notes: null,
    completion_lat: null,
  ...
  },
  {
    ...
    completion_notes: "Frame leveled flush with roadway. Quick-curing mortar applied. Safety cones will remain 2 hours.",
  ...
  },
  {
    ...
    assigned_worker: "Kamal Perera",
    status: "VERIFIED",
    ai_recommendation: "Audit verified: GPS deviation 14.2m (PASS), Before/After evidence verified (PASS), Budget within limits (PASS). Ready for closing.",
    approval_status: "APPROVED",
    approver_name: "Dr. Anura Bandara (Director, Public Works)",
    approval_date: "2026-09-16T09:00:00Z",
    materials_json: ["W-beam steel railing 4m", "Post bolts x8", "Retroreflective tape"],
    before_photo: "https://images.unsplash.com/photo-1542013936693-884638332954?w=600&auto=format&fit=crop&q=80",
    after_photo: "https://images.unsplash.com/photo-1590381105924-c72589b9ef3f?w=600&auto=format&fit=crop&q=80",
  ...
  },
  {
    ...
    actual_cost: 48000, // Significant budget overrun demo
    is_arterial_road: false,
    road_name: "Cotta Road, Borella",
    location_lat: 6.9150,
    location_lng: 79.8830,
    ...
    completion_lat: 6.9350, // 2.2km away! Fails GPS tolerance
    completion_lng: 79.8890,
...
let budgetLogs = [
  ...
  },
  {
    ...
    actual_cost: 27200.00,
    approved_amount: 28000.00,
    remaining_budget: 2800.00,
    approver: "Dr. Anura Bandara (Director, Public Works)",
    approval_date: "2026-09-16T09:00:00Z",
    status: "ACTIVE",
...
let auditLogs = [
  {
    ...
    violations_json: [],
    ai_reasoning: "Safety verification completed successfully. GPS proximity within acceptable tolerance (14.2m <= 50m). Clear before/after photographic evidence confirms replacement of damaged guardrail. Actual expenditure (LKR 27,200) remained below approved limit (LKR 28,000).",
  ...
  },
  {
    ...
    materials_verified: true,
    violations_json: [],
    ai_reasoning: "All routine municipal safety criteria satisfied. Drain grating securely anchored. GPS matched perfectly at 6.8 meters.",
...
module.exports = {
  ...
  auditLogs,
  resetData: () => {
    // Allows resetting demo state during live presentation
  }
};
